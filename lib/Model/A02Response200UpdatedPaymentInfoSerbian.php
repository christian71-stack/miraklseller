...
class A02Response200UpdatedPaymentInfoSerbian extends A02Response200UpdatedPaymentInfo
{
    ...
    protected static $setters = [
        ...
        'bank_branch_number' => 'setBankBranchNumber',
    ...
    protected static $getters = [
        ...
        'bank_branch_number' => 'getBankBranchNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bank_branch_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bank_branch_number']) && (mb_strlen($this->container['bank_branch_number']) > 10)) {
            $invalidProperties[] = "invalid value for 'bank_branch_number', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['bank_branch_number']) && (mb_strlen($this->container['bank_branch_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'bank_branch_number', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setBankAccountNumber($bank_account_number)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bank_account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_account_number when calling A02Response200UpdatedPaymentInfoSerbian., must conform to the pattern /[0-9]+/.");
        }
    ...
    /**
     * Gets bank_branch_number
     *
     * @return string|null
     */
    public function getBankBranchNumber()
    {
        return $this->container['bank_branch_number'];
    }

    /**
     * Sets bank_branch_number
     *
     * @param string|null $bank_branch_number Bank branch number
     *
     * @return self
     */
    public function setBankBranchNumber($bank_branch_number)
    {
        if (is_null($bank_branch_number)) {
            throw new \InvalidArgumentException('non-nullable bank_branch_number cannot be null');
        }
        if ((mb_strlen($bank_branch_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bank_branch_number when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($bank_branch_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bank_branch_number when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 1.');
        }

        $this->container['bank_branch_number'] = $bank_branch_number;
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 0.');
        }
