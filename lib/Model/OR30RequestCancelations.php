...
class OR30RequestCancelations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fees' => '\cbdesk\Mirakl\Model\OR30RequestCancelationsFees[]',
        'order_line_id' => 'string',
        'quantity' => 'int',
        'reason_code' => 'string',
        'shipping_amount' => 'float',
        'shipping_taxes' => '\cbdesk\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]',
        'taxes' => '\cbdesk\Mirakl\Model\OR30RequestCancelationsTaxes[]'
    ];
    ...
    */
     ...
     * Gets fees
     *
     * @return \cbdesk\Mirakl\Model\OR30RequestCancelationsFees[]|null
     */
     ...
     * Sets fees
     *
     * @param \cbdesk\Mirakl\Model\OR30RequestCancelationsFees[]|null $fees The fees to be canceled
     *
     * @return self
     */
     ...
     * Sets order_line_id
     *
     * @param string|null $order_line_id Order line's identifier that must be canceled
     *
     * @return self
     */
     ...
     *
     * @param float|null $shipping_amount The shipping charges part amount to be canceled
     *
     * @return self
     */
     ...
     * Gets shipping_taxes
     *
     * @return \cbdesk\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]|null
     */
     ...
     * Sets shipping_taxes
     *
     * @param \cbdesk\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]|null $shipping_taxes The taxes to be canceled on the shipping price (this field is required if the order has shipping taxes)
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \cbdesk\Mirakl\Model\OR30RequestCancelationsTaxes[]|null
     */
     ...
     * Sets taxes
     *
     * @param \cbdesk\Mirakl\Model\OR30RequestCancelationsTaxes[]|null $taxes The taxes to be canceled on the product price (this field is required if the order has taxes)
     *
     * @return self
     */
