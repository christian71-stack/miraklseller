...
class RT04RequestReturns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_url' => 'string',
        'rma' => 'string',
        'tracking' => '\cbdesk\Mirakl\Model\RT04RequestReturnsTracking'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label_url']) && (mb_strlen($this->container['label_url']) > 2000)) {
            $invalidProperties[] = "invalid value for 'label_url', the character length must be smaller than or equal to 2000.";
        }
     ...
     * Sets label_url
     *
     * @param string|null $label_url Return label URL
     *
     * @return self
     */
    public function setLabelUrl($label_url)
    {
        ...
        if ((mb_strlen($label_url) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $label_url when calling RT04RequestReturns., must be smaller than or equal to 2000.');
        }
     ...
     * Gets tracking
     *
     * @return \cbdesk\Mirakl\Model\RT04RequestReturnsTracking|null
     */
     ...
     * Sets tracking
     *
     * @param \cbdesk\Mirakl\Model\RT04RequestReturnsTracking|null $tracking tracking
     *
     * @return self
     */
