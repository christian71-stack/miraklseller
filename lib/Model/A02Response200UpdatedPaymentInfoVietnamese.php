...
class A02Response200UpdatedPaymentInfoVietnamese extends A02Response200UpdatedPaymentInfo
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bank_account_number']) && (mb_strlen($this->container['bank_account_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'bank_account_number', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['bank_account_number']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['bank_account_number'])) {
            $invalidProperties[] = "invalid value for 'bank_account_number', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
        ...
        if (!is_null($this->container['branch_name']) && (mb_strlen($this->container['branch_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'branch_name', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['branch_name']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['branch_name'])) {
            $invalidProperties[] = "invalid value for 'branch_name', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
    ...
    public function setBankAccountNumber($bank_account_number)
    {
        ...
        if ((mb_strlen($bank_account_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($bank_account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_account_number when calling A02Response200UpdatedPaymentInfoVietnamese., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 0.');
        }
    ...
    public function setBranchName($branch_name)
    {
        ...
        if ((mb_strlen($branch_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $branch_name when calling A02Response200UpdatedPaymentInfoVietnamese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($branch_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $branch_name when calling A02Response200UpdatedPaymentInfoVietnamese., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($branch_name)))) {
            throw new \InvalidArgumentException("invalid value for \$branch_name when calling A02Response200UpdatedPaymentInfoVietnamese., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
