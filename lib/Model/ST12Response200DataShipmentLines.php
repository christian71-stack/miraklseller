...
class ST12Response200DataShipmentLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('package_description', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $package_description Package Description
     *
     * @return self
     * @deprecated
     */
    ...
    {
        if (is_null($package_description)) {
            throw new \InvalidArgumentException('non-nullable package_description cannot be null');
        }
