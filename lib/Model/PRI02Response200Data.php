...
class PRI02Response200Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'offers_in_error' => 'int32',
        'offers_updated' => 'int32',
        'origin' => null,
        'reason_status' => null,
        'shop_id' => 'int64',
        'status' => null
    ...
    protected static $attributeMap = [
        ...
        'offers_in_error' => 'offers_in_error',
    ...
    protected static $setters = [
        ...
        'offers_in_error' => 'setOffersInError',
    ...
    protected static $getters = [
        ...
        'offers_in_error' => 'getOffersInError',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('offers_in_error', $data ?? [], null);
        $this->setIfExists('offers_updated', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets offers_in_error
     *
     * @return int|null
     */
    public function getOffersInError()
    {
        return $this->container['offers_in_error'];
    }

    /**
     * Sets offers_in_error
     *
     * @param int|null $offers_in_error Total count of offers in error
     *
     * @return self
     */
    public function setOffersInError($offers_in_error)
    {
        if (is_null($offers_in_error)) {
            throw new \InvalidArgumentException('non-nullable offers_in_error cannot be null');
        }
        $this->container['offers_in_error'] = $offers_in_error;
     ...
     * Sets offers_updated
     *
     * @param int|null $offers_updated Total count of updated offers
     *
     * @return self
     */
    public function setOffersUpdated($offers_updated)
    {
        if (is_null($offers_updated)) {
            throw new \InvalidArgumentException('non-nullable offers_updated cannot be null');
        }
