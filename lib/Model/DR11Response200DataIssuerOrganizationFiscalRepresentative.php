...
class DR11Response200DataIssuerOrganizationFiscalRepresentative implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $company_registration_name The name of the fiscal representative.
     *
     * @return self
     */
     ...
     *
     * @param string|null $company_registration_number The registration number of the fiscal representative.
     *
     * @return self
     */
     ...
     *
     * @param string|null $country_iso_code The country ISO 3166-1 code of the fiscal representative address.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the fiscal representative.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the fiscal representative.
     *
     * @return self
     */
