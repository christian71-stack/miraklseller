...
class A02Response200UpdatedPaymentInfoIndian extends A02Response200UpdatedPaymentInfo
{
    ...
    protected static $openAPITypes = [
        ...
        'bank_street' => 'string',
        'bank_zip' => 'string',
        'indian_financial_system_code' => 'string',
        'swift_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'bank_street' => null,
        'bank_zip' => null,
        'indian_financial_system_code' => null,
        'swift_code' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'bank_street' => false,
        'bank_zip' => false,
        'indian_financial_system_code' => false,
        'swift_code' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'bank_zip' => 'bank_zip',
        'indian_financial_system_code' => 'indian_financial_system_code',
    ...
    protected static $setters = [
        ...
        'bank_zip' => 'setBankZip',
        'indian_financial_system_code' => 'setIndianFinancialSystemCode',
    ...
    protected static $getters = [
        ...
        'bank_zip' => 'getBankZip',
        'indian_financial_system_code' => 'getIndianFinancialSystemCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('indian_financial_system_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_number']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['account_number'])) {
            $invalidProperties[] = "invalid value for 'account_number', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 6.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling A02Response200UpdatedPaymentInfoIndian., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets indian_financial_system_code
     *
     * @return string|null
     */
    public function getIndianFinancialSystemCode()
    {
        return $this->container['indian_financial_system_code'];
    }

    /**
     * Sets indian_financial_system_code
     *
     * @param string|null $indian_financial_system_code Indian financial system code
     *
     * @return self
     */
    public function setIndianFinancialSystemCode($indian_financial_system_code)
    {
        if (is_null($indian_financial_system_code)) {
            throw new \InvalidArgumentException('non-nullable indian_financial_system_code cannot be null');
        }
        $this->container['indian_financial_system_code'] = $indian_financial_system_code;
