...
class OR32Response200OrderLinesAdjustedCancelations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eco_contributions' => '\cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsEcoContributions[]',
        'quantity' => 'int',
        'reason_code' => 'string',
        'shipping_amount' => 'float',
        'shipping_taxes' => '\cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsShippingTaxes[]',
        'taxes' => '\cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsTaxes[]'
    ];
    ...
    */
     ...
     *
     * @return \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsEcoContributions[]|null
     */
     ...
     *
     * @param \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsEcoContributions[]|null $eco_contributions List of eco-contribution amounts and corresponding producer identifiers, if applicable<br/> Only available if the operator activates the circular economy information collection.
     *
     * @return self
     */
     ...
     *
     * @param float|null $shipping_amount The shipping charges part amount canceled
     *
     * @return self
     */
     ...
     * Gets shipping_taxes
     *
     * @return \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsShippingTaxes[]|null
     */
     ...
     * Sets shipping_taxes
     *
     * @param \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsShippingTaxes[]|null $shipping_taxes The taxes canceled on the shipping price
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsTaxes[]|null
     */
     ...
     * Sets taxes
     *
     * @param \cbdesk\Mirakl\Model\OR32Response200OrderLinesAdjustedCancelationsTaxes[]|null $taxes The taxes canceled on the product price
     *
     * @return self
     */
