...
class OR28Response200Refunds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'amount' => 'float',
        'amount_breakdown' => '\cbdesk\Mirakl\Model\OR28Response200RefundsAmountBreakdown',
        'currency_iso_code' => 'string',
        'eco_contributions' => '\cbdesk\Mirakl\Model\OR28Response200RefundsEcoContributions[]',
        'excluded_from_shipment' => 'bool',
        'fees' => '\cbdesk\Mirakl\Model\OR28Response200RefundsFees[]',
        'order_line_id' => 'string',
        'order_refund_id' => 'string',
        'purchase_information' => '\cbdesk\Mirakl\Model\OR28Response200RefundsPurchaseInformation',
        'quantity' => 'int',
        'reason_code' => 'string',
        'refund_id' => 'string',
        'shipping_amount' => 'float',
        'shipping_amount_breakdown' => '\cbdesk\Mirakl\Model\OR28Response200RefundsShippingAmountBreakdown',
        'shipping_taxes' => '\cbdesk\Mirakl\Model\OR28Response200RefundsShippingTaxes[]',
        'taxes' => '\cbdesk\Mirakl\Model\OR28Response200RefundsTaxes[]'
    ];
    ...
    protected static $setters = [
        ...
        'excluded_from_shipment' => 'setExcludedFromShipment',
        'fees' => 'setFees',
    ...
    protected static $getters = [
        ...
        'excluded_from_shipment' => 'getExcludedFromShipment',
        'fees' => 'getFees',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('excluded_from_shipment', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsAmountBreakdown|null
     */
     ...
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsAmountBreakdown|null $amount_breakdown amount_breakdown
     *
     * @return self
     */
     ...
     *
     * @param string|null $currency_iso_code The currency (iso format) used by the shop (the field is required if the shop is not using the default Operator platform currency)
     *
     * @return self
     */
     ...
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsEcoContributions[]|null
     */
     ...
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsEcoContributions[]|null $eco_contributions List of eco-contribution amounts and corresponding producer identifiers, if applicable<br/> Only available if the operator activates the circular economy information collection.
     *
     * @return self
     */
    ...
    /**
     * Gets excluded_from_shipment
     *
     * @return bool|null
     */
    public function getExcludedFromShipment()
    {
        return $this->container['excluded_from_shipment'];
    }

    /**
     * Sets excluded_from_shipment
     *
     * @param bool|null $excluded_from_shipment Exclude the refunded quantity from shipments
     *
     * @return self
     */
    public function setExcludedFromShipment($excluded_from_shipment)
    {
        if (is_null($excluded_from_shipment)) {
            throw new \InvalidArgumentException('non-nullable excluded_from_shipment cannot be null');
        }
        $this->container['excluded_from_shipment'] = $excluded_from_shipment;
     ...
     * Gets fees
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsFees[]|null
     */
     ...
     * Sets fees
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsFees[]|null $fees List of fees refunded on the order line
     *
     * @return self
     */
     ...
     * Sets order_line_id
     *
     * @param string|null $order_line_id The identifier of the order line on which the refund has been created
     *
     * @return self
     */
     ...
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsPurchaseInformation|null
     */
     ...
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsPurchaseInformation|null $purchase_information purchase_information
     *
     * @return self
     */
     ...
     * Sets refund_id
     *
     * @param string|null $refund_id The identifier of the created refund
     *
     * @return self
     */
     ...
     *
     * @param float|null $shipping_amount The shipping charges part amount of the refund
     *
     * @return self
     */
     ...
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsShippingAmountBreakdown|null
     */
     ...
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsShippingAmountBreakdown|null $shipping_amount_breakdown shipping_amount_breakdown
     *
     * @return self
     */
     ...
     * Gets shipping_taxes
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsShippingTaxes[]|null
     */
     ...
     * Sets shipping_taxes
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsShippingTaxes[]|null $shipping_taxes List of taxes refunded on shipping charges
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \cbdesk\Mirakl\Model\OR28Response200RefundsTaxes[]|null
     */
     ...
     * Sets taxes
     *
     * @param \cbdesk\Mirakl\Model\OR28Response200RefundsTaxes[]|null $taxes List of taxes refunded on product price
     *
     * @return self
     */
