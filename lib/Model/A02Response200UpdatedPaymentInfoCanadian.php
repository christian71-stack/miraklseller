    ...
    */
    ...
    public function setBankAccountNumber($bank_account_number)
    {
        ...
        if ((mb_strlen($bank_account_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($bank_account_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bank_account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_account_number when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 0.');
        }
    ...
    public function setInstitutionNumber($institution_number)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($institution_number)))) {
            throw new \InvalidArgumentException("invalid value for \$institution_number when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setTransitNumber($transit_number)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($transit_number)))) {
            throw new \InvalidArgumentException("invalid value for \$transit_number when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
