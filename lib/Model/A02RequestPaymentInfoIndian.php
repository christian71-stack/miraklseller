    ...
    */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02RequestPaymentInfoIndian., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02RequestPaymentInfoIndian., must be bigger than or equal to 6.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling A02RequestPaymentInfoIndian., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02RequestPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02RequestPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02RequestPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02RequestPaymentInfoIndian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02RequestPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02RequestPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02RequestPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02RequestPaymentInfoIndian., must be bigger than or equal to 0.');
        }
