...
class A02RequestProDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets corporate_name
     *
     * @param string|null $corporate_name Corporate name of the shop. Not nullable.
     *
     * @return self
     */
     ...
     *
     * @param string|null $identification_number Identification number of the shop. For France it would be the SIRET. Only nullable if the country_iso_code corresponds to USA.
     *
     * @return self
     */
     ...
     *
     * @param string|null $tax_identification_number Tax identification number of the shop. Nullable.
     *
     * @return self
     */
