    ...
    */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling A01Response200PaymentInfoColombian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A01Response200PaymentInfoColombian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A01Response200PaymentInfoColombian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A01Response200PaymentInfoColombian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A01Response200PaymentInfoColombian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A01Response200PaymentInfoColombian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A01Response200PaymentInfoColombian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A01Response200PaymentInfoColombian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A01Response200PaymentInfoColombian., must be bigger than or equal to 0.');
        }
