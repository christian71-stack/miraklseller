...
/**
 * A02Response200UpdatedPaymentInfoPhilippines Class Doc Comment
 *
 * @category Class
 * @package  cbdesk\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoPhilippines extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Philippines';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bank_account_number']) && (mb_strlen($this->container['bank_account_number']) > 16)) {
            $invalidProperties[] = "invalid value for 'bank_account_number', the character length must be smaller than or equal to 16.";
        }

        if (!is_null($this->container['bank_account_number']) && (mb_strlen($this->container['bank_account_number']) < 10)) {
            $invalidProperties[] = "invalid value for 'bank_account_number', the character length must be bigger than or equal to 10.";
        }
    ...
    public function setBankAccountNumber($bank_account_number)
    {
        ...
        if ((mb_strlen($bank_account_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoPhilippines., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($bank_account_number) < 10)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling A02Response200UpdatedPaymentInfoPhilippines., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bank_account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_account_number when calling A02Response200UpdatedPaymentInfoPhilippines., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoPhilippines., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoPhilippines., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoPhilippines., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoPhilippines., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoPhilippines., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoPhilippines., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoPhilippines., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoPhilippines., must be bigger than or equal to 0.');
        }
