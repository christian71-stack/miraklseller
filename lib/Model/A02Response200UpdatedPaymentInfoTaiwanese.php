...
class A02Response200UpdatedPaymentInfoTaiwanese extends A02Response200UpdatedPaymentInfo
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_number']) && (mb_strlen($this->container['account_number']) > 14)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 14.";
        }
        ...
        if (!is_null($this->container['bank_code']) && (mb_strlen($this->container['bank_code']) > 3)) {
            $invalidProperties[] = "invalid value for 'bank_code', the character length must be smaller than or equal to 3.";
        }

        if (!is_null($this->container['bank_code']) && (mb_strlen($this->container['bank_code']) < 2)) {
            $invalidProperties[] = "invalid value for 'bank_code', the character length must be bigger than or equal to 2.";
        }

        if (!is_null($this->container['bank_code']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['bank_code'])) {
            $invalidProperties[] = "invalid value for 'bank_code', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
        ...
        if (!is_null($this->container['branch_code']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['branch_code'])) {
            $invalidProperties[] = "invalid value for 'branch_code', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 14)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($account_number) < 8)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling A02Response200UpdatedPaymentInfoTaiwanese., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bank_city)
    {
        ...
        if ((mb_strlen($bank_city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_city) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_city when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 3.');
        }
    ...
    public function setBankCode($bank_code)
    {
        ...
        if ((mb_strlen($bank_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($bank_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $bank_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($bank_code)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bank_street)
    {
        ...
        if ((mb_strlen($bank_street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bank_street) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bank_street when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bank_zip)
    {
        ...
        if ((mb_strlen($bank_zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_zip when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 0.');
        }
    ...
    public function setBranchCode($branch_code)
    {
        ...
        if ((mb_strlen($branch_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $branch_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($branch_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $branch_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($branch_code)))) {
            throw new \InvalidArgumentException("invalid value for \$branch_code when calling A02Response200UpdatedPaymentInfoTaiwanese., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
